"""Register the evidence-aware extraction prompt used by the formal content path.

Revision ID: 0059_phase5_extract_prompt_v2
Revises: 0058_phase5_technical_exception_acl
"""
...
revision = "0059_phase5_extract_prompt_v2"
down_revision = "0058_phase5_technical_exception_acl"
branch_labels: str | Sequence[str] | None = None
depends_on: str | Sequence[str] | None = None

PROMPT_ID = "019fbe20-0000-7000-8000-000000000101"
PROMPT_VERSION = "ai01-extract-v2"
SYSTEM_PROMPT = (
...
def upgrade() -> None:
    ...
    if tuple(registered) != (PROMPT_ID, prompt_hash):
        raise RuntimeError("0059_EXTRACTION_PROMPT_IDENTITY_MISMATCH")
...
def downgrade() -> None:
    ...
    if used:
        raise RuntimeError("0059_DOWNGRADE_BLOCKED: extraction prompt has durable uses")
