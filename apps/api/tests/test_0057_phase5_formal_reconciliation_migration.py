...
def test_formal_reconciliation_verifier_uses_the_disposable_legacy_seam() -> None:
    ...
    assert '_HEAD = "0060_phase5_extract_prompt_v3"' in source
    ...
    assert "0058_TECHNICAL_EXCEPTION_API_READ_MISSING" in source
    assert "0058_TECHNICAL_EXCEPTION_API_WRITE_LEAK" in source
