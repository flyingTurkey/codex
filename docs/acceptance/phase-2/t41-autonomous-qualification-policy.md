...
- CI integration isolation: the integration job creates and exports a runner-scoped ephemeral `SRBG_DATA_ROOT` before Compose startup; production and local data-root requirements remain unchanged.
