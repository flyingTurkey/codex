...
当前真实样例详情返回 `published_at=2026-07-07` 和 title 两条 accepted claims，对应 Evidence IDs `019f75c0-e4e4-75d8-9f18-536a0932202f`、`019f75c0-e4df-730a-83d4-cb8ef66c68be`，定位均为 `PDF_TEXT`，内容 SHA-256 均有效。只读界面审查材料位于 `D:\SRBGData\reports\ui-review\core-pages-20260719T0225Z`；正式界面仍未修改。
