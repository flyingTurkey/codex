...
SourceAdmission is independent from document qualification. It pauses on hard public-network/access restrictions and explicit robots, terms or copyright prohibitions. Missing legal metadata and soft-yield observations permit bounded collection; HUMAN_OWNER Gold and model output never authorize a source.
