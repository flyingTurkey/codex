...
读取：docs/codex-kit/docs/01-PRD.md、docs/codex-kit/docs/02-content-model.md、docs/codex-kit/docs/04-data-source-compliance.md、docs/codex-kit/assets/taxonomy.yaml、docs/codex-kit/assets/content.schema.json、docs/codex-kit/assets/validation/publication_gate.json、docs/codex-kit/assets/validation/publication_evaluation.schema.json。
...
验收：make fixture-replay quality-gate web-e2e web-a11y 与全局门禁全部通过。
