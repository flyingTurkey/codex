...
export type DetectedMime = 'text/html' | 'application/pdf'
export type Id2 = string
export type ScanStatus = 'CLEAN' | 'REJECTED'
export type Sha256 = string
export type SourceId = string
export type SourceName = string
export type RawObjectDeduplicated = boolean
export type VersionCreated = boolean

export interface FixtureUploadResponse {
  document: DocumentDetail
  raw_object_deduplicated: RawObjectDeduplicated
